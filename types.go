...
// CPEOptions contains the options for searching cves by cpe
// Note: At least one of the fields must be set
type CPEOptions struct {
	// Cpe string is the cpe string to search
	Cpe string `json:"cpe"`
	// Product is the product to search
	Product string `json:"product"`
	// Vendor is the vendor to search
	Vendor string `json:"vendor"`
}

// CPEResponse contains the response for the cpe search
...
// CVEBulkData contains the bulk data for cves
...
// CVEData contains the data for a single cve
type CVEData struct {
	...
	Weaknesses      []Weaknesses      `json:"weaknesses,omitempty"`
	...
	Hackerone       H1                `json:"hackerone,omitempty"`
